 ...
 //fputs($socket, "Interface: Mr-Gheshlaghi (Local/205@from-queue/n from hint:205@ext-local)\r\n\r\n");
...
fputs($socket2, "Action: QueueRemove\r\n");
fputs($socket2, "queue: $qnum\r\n");
//fputs($socket2, "Interface: sip/$ext (Ms Mirzaei (Local/$ext@from-queue/n from hint:$ext@ext-local) from sip/$ext)\r\n\r\n");
