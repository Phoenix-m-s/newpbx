...
(/** @lends <global> */function( $ ) {
	 ...
	 *  @param {object} src The component object which holds all parameters that can be
	 *    mapped.
	...
	{
		_fnCompatMap( init, 'order',     'bSortable' );
	...
	/*
	 * Developer note - See note in component.defaults.js about the use of Hungarian
	...
	DataTable.defaults.column = {
		 ...
		 *  @default true
		 *
		 *  @name DataTable.defaults.column.order
		 *  @dtopt Columns
		 *
		 *  @example
		 *    // Using `columnDefs`
	...
	// Built in type detection. See component.ext.aTypes for information about
	...
	// Filter formatting functions. See component.ext.ofnSearch for information about
