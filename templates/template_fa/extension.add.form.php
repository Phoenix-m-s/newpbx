        ...
        <form name="addExtension" id="addExtension" role="form" data-validate="form" enctype="multipart/form-data" class="form-horizontal form-bordered formtimecondition" autocomplete="off" novalidate="novalidate" method="post">
            ...
            <div id="panel-tablesorter" class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title"><?=EXTENSION_14?></h3>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-md-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-12 col-md-6 pull-left">
                                                <input type="text" class="form-control" name="extension_no" id="extension_no" autocomplete="off" placeholder="<?=EXTENSION_16?>" required >
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-md-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-12 col-md-6 pull-left">
                                                <input type="email" class="form-control" name="username" id="username" autocomplete="off" placeholder="<?=EXTENSION_30?>" required >
                                            </div>
                                        </div>
                                    </div>
                                    <!---------------------------------- Password ------------------------------------------->
                                    <div class="col-xs-12 col-md-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-12 col-md-6 pull-left">
                                                <input type="text" class="form-control" name="password" id="password" autocomplete="off" placeholder="<?=EXTENSION_37?>" required >
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-12 col-md-6 pull-left">
                                                <input type="text" class="form-control" name="voicemail_pass" id="voicemail_pass"
                                                       placeholder=<?=EXTENSION_23?>" required ">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-xs-12 col-md-3">
                                        ...
                                        <div class="col-xs-12 col-md-12">
                                            <select name="successDialDestination" class="successDialDestination select2 col-xs-12 col-md-11 no-padding no-marginTop" id="1" title="">
                                                <option value="successDirectDial" >Direct Dial</option>
                                                <option value="successTimeCondition"  >Time Condition</option>
                                                <option value="successVoiceMail"  >Voice Mail</option>
                                                <option value="successForwarding" >Forwarding</option>
                                            </select>
                                        </div>
                                    </div>
                                    <!----------------------- Success Forward ----------------------->
                                    ...
                                    <div class="col-xs-12 col-md-3">
                                        ...
                                        <div class="failedDSTOption col-xs-12 col-md-12" data-status="failedDSTOption" id="0-2">
                                            ...
                                            <?php } elseif ($list['failedDialDestination'] == 'failedForwarding' & $list['failedForward'] == 'external') { ?>
                                                <input type='text'  class='form-control col-xs-12 col-md-11' name='failedDSTOption' id='external' placeholder='Enter Phone Number'>
                                            <?php } ?>
                                        </div>
                                    </div>
            ...
            <!--  <p class="pull-left">
                <button title="Submit" type="submit" name="action" id="action"  class="btn btn-success btn-icon">
                    <i class="fa fa-download"></i>Submit  <?/*=IVR_28*/?> extension
                </button>
            </p>-->
            <div class="col-md-12">
                <p class="pull-left">
                    <button type="submit" name="update" id="submit" class="btn btn-icon btn-success">
                        <input type="hidden"  name="action" id="action" value="addExtension">
...
//----------------------------- Success Dial Destination part of the Form (Left Side) -----------------------------//
            ...
            $(document).on("change", ".successDialDestination", function(e){
                ...
                var ExtensionId = <?=strlen($list['extension_id']) ? $list['extension_id'] : 0?>;
                $.ajax({
