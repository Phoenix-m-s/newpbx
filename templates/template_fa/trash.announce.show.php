...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function() {
        ...
        var oTable = dataTable.DataTable( {
            "processing": true,
            "serverSide": true,
            "ajax": "<?=RELA_DIR?>trash.php?action=searchAnnounceTrash&ajax=1"
        } );
...
<div class="content active">
    <div class="content-header">
        <h2 class="content-title"><i class="fa fa-user"></i><?php echo TRASH_01?></h2>
    </div><!--/content-header -->
    <div class="content-body">
        <div id="panel-tablesorter" class="panel panel-warning">
            <div class="panel-heading bg-white">
                <h3 class="panel-title"><?php echo TRASH_01?></h3>
            ...
            <div class="panel-body">
                ...
                ?>
                <!--form-->
                <form method="post" action="<?=RELA_DIR.'announce.php?action=changeStatus';?>" name="action" id="action">
                    <div class="content-body">
                        ...
                        <table id="example" class="companyTable table table-striped table-bordered" cellspacing="0" width="100%">
                            <thead>
                            <tr>
                                <th><?php echo ANNOUNCE_03?></th>
                                <th><?php echo ANNOUNCE_04?></th>
                                <th><?php echo ANNOUNCE_05?></th>
                                <th><?php echo ANNOUNCE_06?></th>
                                <th><?php echo ANNOUNCE_07?></th>
                                <th><?php echo ANNOUNCE_08?></th>
                                <th><?php echo ANNOUNCE_09?></th>
                                <th><?php echo ANNOUNCE_10?></th>
                                <th><?php echo ANNOUNCE_11?></th>
                            </tr>
                            </thead>
                            <tfoot>
                            <tr>
