...
<aside class="side-left transition" id="side-left">
    <ul class="sidebar">
        ...
        <li>
            <a href="<?php echo RELA_DIR.'announce.php?action=showAnnounce'?>" class="">
                ...
                <span class="sidebar-text"><?php echo ANNOUNCE_01; ?></span> </a>
        </li>
        <li>
        ...
        <li>
            <?php
                     global $member_info;
                     if($member_info == -1) { ?><a href="<?php echo RELA_DIR.'extension.php?action=showExtensions'?>">
                <i class="sidebar-icon fa fa-phone"></i> <span class="sidebar-text"><?php echo RIGHTMENU_05; ?></span>
            </a><?php } else { ?>
        ...
        <li>
            <a href="<?php echo RELA_DIR.'upload.php?action=showUploads'?>"> <i class="sidebar-icon fa fa-file"></i>
                <span class="sidebar-text"><?php echo RIGHTMENU_06; ?></span> </a>
        </li>
        <li>
            <a href="<?php echo RELA_DIR.'ivr.php?action=showIvr'?>"> <i class="sidebar-icon fa fa-phone-square"></i>
                <span class="sidebar-text"><?php echo RIGHTMENU_07; ?></span> </a>
        </li>
        <li>
            <a href="<?php echo RELA_DIR.'queue.php?action=showQueues'?>"> <i class="sidebar-icon fa fa-users"></i>
        ...
        <li>
            <a href="<?php echo RELA_DIR.'report.php?action=showReport'?>">
                <span class="sidebar-text"><?php echo RIGHTMENU_15; ?></span> </a>
        </li>
    ...
    <li>
       ...
       -->
        ...
        <li>
            <a href="<?= RELA_DIR.'extension.php?action=editExtension&id='.$member_info['extension_id']?>">
                <i class="sidebar-icon fa fa-phone"></i> <span class="sidebar-text"><?php echo RIGHTMENU_37; ?>?action</span>
            </a>
        </li>
        <?php } ?>
