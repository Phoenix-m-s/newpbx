...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function() {
        ...
        var oTable = dataTable.DataTable( {
            "processing": true,
            "serverSide": true,
            "ajax": "<?=RELA_DIR;?>admin.package.php?action=searchPackage&ajax=1"
        } );
...
<div class="content active">
    <div class="content-control">
        ...
        <ul class="control-nav pull-left">
            <li>
                <a class="text-20">  <?php echo PACKAGE_09?>
                </a>
            </li>
        </ul><!--/control-nav-->
    </div>
    <!--<div class="content-header">
        <h2 class="content-title"><i class="fa fa-user"></i><?php /*echo PACKAGE_09*/?></h2>
    </div>--><!--/content-header -->
    <div class="content-body">
        <div id="panel-tablesorter" class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><?php echo PACKAGE_09?></h3>
                ...
                <form method="post" action="<?=RELA_DIR.'package.php?action=changePackageStatus';?>" name="action" id="action">
                    <div class="content-body">
                        <div class="pull-left margin-bottom">
                            <!--addSip-->
                            <a href="<?php echo RELA_DIR.'admin.package.php?action=addPackage'?>" class="btn btn-primary btn-sm btn-icon text-13"><i class="fa fa-plus"></i><?=ADD; ?></a>
                            <!--active-->
                        </div>
                       <!-- <div class="pull-left margin-bottom"><a href="<?php /*echo RELA_DIR.'basket.php?action=showBasket'*/?>" class="btn btn-icon btn-warning">
                        ...
                        <table id="example" class="companyTable table table-striped table-bordered" cellspacing="0" width="100%">
                            <thead>
                            <tr>
                                <th><?php echo PACKAGE_10?></th>
                                <th><?php echo PACKAGE_11?></th>
                                <th><?php echo PACKAGE_12?></th>
                                <th><?php echo PACKAGE_13?></th>
                                <th><?php echo PACKAGE_14?></th>
                                <th><?php echo PACKAGE_15?></th>
                                <th><?php echo PACKAGE_16?></th>
                                <th><?php echo PACKAGE_17?></th>
                            </tr>
                            </thead>
                            <tfoot>
                            <tr>
