<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function() {
        ...
        var oTable = dataTable.DataTable( {
            "processing": true,
            "serverSide": true,
            "ajax": "<?=RELA_DIR?>trash.php?action=searchUploadTrash&ajax=1"
        } );
...
<div class="content active">
    <div class="content-header">
        <h2 class="content-title"><i class="fa fa-user"></i><?php echo TRASH_04?></h2>
    </div><!--/content-header -->
    ...
    <div class="content-body">
        <div id="panel-tablesorter" class="panel panel-warning">
            <div class="panel-heading bg-white">
                <h3 class="panel-title"><?php echo TRASH_04?></h3>
            ...
            <div class="panel-body">
                ...
                ?>
                <form method="post" action="<?=RELA_DIR.'upload.php?action=changeStatus';?>" name="action" id="action">
                    <table id="example" class="companyTable table table-striped table-bordered" cellspacing="0" width="100%">
                        <thead>
                        <tr>
                            <th><?php echo UPLOAD_02 ?></th>
                            <th><?php echo UPLOAD_03 ?></th>
                            <th><?php echo UPLOAD_04 ?></th>
                            <th><?php echo UPLOAD_05 ?></th>
                            <th><?php echo UPLOAD_06 ?></th>
                            <th><?php echo UPLOAD_07 ?></th>
                        </tr>
                        </thead>
