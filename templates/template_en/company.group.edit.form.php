...
<div class="content active">
    <!--<div class="content-header">
        <h2 class="content-title"><i class="fa fa-user"></i><?php /*echo CompanyGroup_09 */?></h2>
    </div>--><!--/content-header -->
    <div class="content-control">
        <!--control-nav-->
        <ul class="control-nav pull-left">
            <li>
                <a class="text-20" href="">
                    <?php echo CompanyGroup_09 ?>
                </a>
            </li>
        </ul><!--/control-nav-->
    </div>
    <div class="content-body">
        ...
        <div id="panel-tablesorter" class="panel  panel-default">
            <div class="panel-heading bg-white">
                <h3 class="panel-title"><?php echo CompanyGroup_09 ?></h3>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12  center-block">
                        ...
                        <form name="addCompany" id="addCompany" role="form" data-validate="form" class="form-horizontal form-bordered" autocomplete="off" novalidate="novalidate" method="post">
                            <input name="id" id=id type="hidden" value="<?=$list['comp_group_id']?>"/>
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-6">
                                    <div class="form-group">
                                        <label class="col-xs-12 col-sm-4 pull-left control-label" for="Group_Name"><?php echo CompanyGroup_04 ?>:</label>
                                        <div class="col-xs-12 col-sm-6 pull-left">
                                            <input type="text" class="form-control" name="Group_Name" id="Group_Name" autocomplete="off" placeholder="<?php echo CompanyGroup_04 ?>" value="<?=$list['Group_Name']?>" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-6">
                                ...
                                <div class="col-md-12">
                                    <p class="pull-left">
                                        <button type="submit" name="update" id="submit" class="btn btn-icon btn-success">
                                           ...
                                           submit <?php echo CompanyGroup_10 ?>
                                        </button>
                                    </p>
                                </div>
                            </div>
