                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="row">
                                ...
                                <div class="col-md-7 margin-top-half bootstrap-timepicker">
...
<script>
    $(function () {
        ...
        $body.find('[data-input="timepicker"]').each(function() {
            ...
            $this.timepicker({
                appendWidgetTo: $this.parent('.col-md-7')
            });
        });
        ...
        var oTable = dataTable.DataTable({
            ...
            scrollCollapse: true,
            paging: true,
            ajax: "<?=RELA_DIR?>report.php?action=searchExtension&ajax=1<?=($result);?>",
            "ordering": true,
        });
        ...
        oTable.columns().every(function () {
            ...
            $('#example input', this.footer()).on('keyup change', function () {
