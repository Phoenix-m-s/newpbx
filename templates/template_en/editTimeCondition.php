...
<div class="content active">
   <!-- <div class="content-header">
        <h2 class="content-title"><i class="fa fa-user"></i><?/*=EXTENSION_42*/?></h2>
    </div>--><!-- content-header -->
    <div class="content-control">
        <!--control-nav-->
        <ul class="control-nav pull-left">
            <li>
                <a class="text-20" href="<?=RELA_DIR?>mainTimeCondition.php">
                    edit TimeCondition
                </a>
            </li>
        </ul><!--/control-nav-->
    </div>
    <form name="addExtension" id="addExtension" role="form" data-validate="form" class="form-horizontal form-bordered" autocomplete="off" novalidate="novalidate" method="post">

    <div class="content-body">

        <div id="panel-tablesorter" class="panel panel-default  margin-top">
            <div class="panel-heading">
                <h3 class="panel-title"><?=EXTENSION_42?></h3>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12  center-block">
                            ...
                            if ($list['error'][$i] == 1) {
                                ...
                                echo "<p id='conflictMessage' style=' font-size: 20px; background: #ddd; color:black; font-weight: bold; height:50px; padding-top: 10px; text-align: center; border-radius: 20px; background:#777; cursor: pointer; '>
                            ...
                            <div class="jumbotron timeTable timeTable<?= $i ?>" <?=($list['error'][$i] == 1 or $list['error'][$i] == 2)?$style:''?> style="box-shadow: 5px 4px 15px black;">
                                <div style="cursor: pointer; font-size: 20px; height:60px;">
                                    <i style="color:red;" class="fa fa-times deleteTimeTable" aria-hidden="true" id="<?= $i ?>"></i>
                                </div>

                                <input type="hidden" id="TCID" name="TCID<?=$list['id'][$i]?>" value="<?=$list['id'][$i]?>" >
                                <!---------------------------------- Hour Start ------------------------------------------->
                                <div class="row ">
                                ...
                                <div class="row" style="border:none; border-top: 1px dashed black; padding: 20px; " >
                                    <div class="form-group col-xs-12 col-md-3">
                                        <label class="col-xs-12 col-sm-5 pull-left control-label ltr ">
                                        ...
                                        <div class="col-xs-6 col-md-7">
                                            <select name="dialExtension[]" class="dialExtension select2"
                                                ...
                                                <?php  foreach ($list['dialExtensionList'] as $key => $value) { ?>
                                                    ...
                                                    <option value="<?php echo $value?>" <?php echo $value == $list['dialExtension'][$i] ? 'selected' : '' ?> > <?php echo $value ?> </option>
                                                <?php }
                                                ?>
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group col-xs-12 col-md-3"  >
                                        <?php if ($list['dialExtension'][$i] =='forward'){?>
                                        <div class="col-xs-12 col-md-11 " id="<?=$i?>-3"  style="display: none">
                                            <?php } else {  ?>
                                            <div class="col-xs-12 col-md-11 " id="<?=$i?>-3">
                                            ...
                                            <div class="col-xs-6 col-md-11" data-status="DSTOption" id="<?=$i?>-2">
                                                <?php if ($list['dialExtension'] [$i] == 'forward' & $list['forward'][$i] == 'internal') { ?>
                                                    <select name="DSTOption[]" class="DSTOption select2"
                                                            id="DSTOption"  required>
                                                        <?php  foreach ($list['extensionList'] as $key => $value) { ?>
                                                            <option value="<?= $key ?>" <?= $key == $list['DSTOption'][$i] ? 'selected' : '' ?> > <?= $value; ?> </option>
                                                        <?php } ?>
                                                    </select>
                                ...
                                if ($list['plus'] == 1) { ?>
                                    <div class="jumbotron row timeTable timeTable<?= $deleteCounter ?>" style="box-shadow: 5px 4px 15px black;">
                                        ...
                                        <div class="row" style="border-top: 1px dotted black; padding: 20px;">
                                            ...
                                            <div class="form-group col-xs-6 col-md-3">
                                                <div class="col-xs-12 col-md-11 forward" id='<?=$i?>-1'>
                                            ...
                                            <div class="form-group col-xs-6 col-md-3">
                                                <div class="col-xs-12 col-md-11 DSTOption" data-status="DSTOption" id="<?=$i?>-2">
                                                    <!----------- there will be a select box using ajax ----------->
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <p class="pull-left">
                                            <button type="submit" name="plus" id="edit" class="btn btn-icon btn-success ltr"> 
                                ...
                                <!------------------------- Failed Side ------------------------------>
                                    ...
                                    <div class="form-group col-xs-12 col-sm-3 border-none">
                                        <label class="col-xs-6 col-sm-5 pull-left control-label ltr">
                                            Destination after playback </label>
                                        <div class="col-xs-6 col-md-7">
                                            <select name="FDialExtension" class="FDialExtension select2" id="<?=$i + 1?>" title="" required>
                                                <?php foreach ($list['dialExtensionList'] as $key => $value) { ?>
                                    ...
                                    <div class="form-group col-xs-12 col-sm-3 border-none">
                                        <?php if ($list['dialExtensionList'][$i] =='voiceMail'){?>
                                        <div id="<?=$i + 1?>-3" class="col-xs-6 col-md-11">
                                            <?php } else { ?>
                                            <div id="<?= $i + 1 ?>-3" class="col-xs-6 col-md-11" style="display: none">
                                                <select name="FSub_dst[]" class="dialExtension select2"
                                                    ...
                                                    if (isset($list['sub_dst_list']) and !empty($list['sub_dst_list'])) {
                                                        foreach ($list['sub_dst_list'] as $key => $value) { ?>
                                                            <option value="<?= $value['extension_id'] ?>" <?= $value['extension_id'] == $list['FSub_dst'] ? 'selected' : '' ?> > <?= $value['extension_no'] ?></option>
                                                            <?php
                                                        }
                                                    }
                                                    }
                                        ...
                                        <!---------------------------------- Failed Forward ------------------------------------------->
                                        <div class="form-group col-xs-12 col-sm-3 border-none">
                                            <div class="FForward col-xs-6 col-md-11" id='<?=$i + 1?>-1'>
                                            ...
                                            <div class="col-xs-6 col-md-11" data-status="FDSTOption" id="<?=$i + 1?>-2">
                                                ...
                                                <?php } else { ?>
                                                    ...
                                                    <?php } elseif ($list['FDialExtension'] == 'voiceMail' & $list['FForward'] == 'customMessageByRecord') { ?>
                                                        <div id="TCRecordVoiceLink" class="col-xs-12 col-sm-12" style="text-align: center;">
                                                            <input type="text" name="voiceTitle" class="form-control" id="voiceTitle<?=$i + 1?>" title="Input the Voice Title" placeholder="Input The Voice Title" required>
                                                            <audio controls src="" id="audio"></audio>
                                                            <div class="row">
...
//                    var result = $.parseHTML(response, true);
        ...
        $(".FForward").on('change', function(){
            ...
            $.ajax({
                ...
                data: {forward: value, ID: <?=$_GET['id']?>, recordId: recordID},
                type: 'POST',
                success: function (response) {
                    $(DSTOption).html(response);
                    $(DSTOption).find('select').select2();
