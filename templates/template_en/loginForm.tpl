<div class="content content-full loginPage">

    <div class="signin-brand">
        <a href="<?php echo RELA_DIR; ?>login.php">
            <img class="lazy center-block"
                 src="<?php echo RELA_DIR; ?>templates/<?php echo CURRENT_SKIN; ?>/images/logo.png"
                 data-original="<?php echo RELA_DIR; ?>templates/<?php echo CURRENT_SKIN; ?>/images/daba-logo.jpg"
                 alt="Sign In">
        </a>
    </div>
    <div class="signin">
        <form action="<?php echo RELA_DIR; ?>login.php" method="POST" data-validate="form" role="form">
