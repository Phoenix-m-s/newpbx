...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function() {
        ...
        var oTable = dataTable.DataTable( {
            "processing": true,
            "serverSide": true,
            "ajax": "<?=RELA_DIR?>trash.php?action=searchQueueTrash&ajax=1"
        } );
...
<div class="content active">
    <div class="content-header">
        <h2 class="content-title"><i class="fa fa-user"></i><?php echo TRASH_06 ?></h2>
    </div><!--/content-header -->
    <div class="content-body">
        <div id="panel-tablesorter" class="panel panel-warning">
            <div class="panel-heading bg-white">
                <h3 class="panel-title"><?php echo TRASH_06 ?></h3>
...
-->
                        <table id="example" class="companyTable table table-striped table-bordered" cellspacing="0" width="100%">
                            <thead>
                            <tr>
                                <th><?php echo QUEUE_03 ?></th>
                                <th><?php echo QUEUE_04 ?></th>
                                <th><?php echo QUEUE_05 ?></th>
                                <th><?php echo QUEUE_06 ?></th>
                                <th><?php echo QUEUE_07 ?></th>
                                <th><?php echo QUEUE_08 ?></th>
                                <th><?php echo QUEUE_09 ?></th>
                                <th><?php echo QUEUE_10 ?></th>
                                <th><?php echo QUEUE_11 ?></th>
                                <th><?php echo QUEUE_12 ?></th>
                                <th><?php echo QUEUE_13 ?></th>
                                <th><?php echo QUEUE_14 ?></th>
                                <th><?php echo QUEUE_15 ?></th>
                                <th><?php echo QUEUE_16 ?></th>
                                <th><?php echo QUEUE_17 ?></th>
                            </tr>
                            </thead>
                            <tfoot>
                            <tr>
