        ...
        <form name="outbound" id="outbound" role="form" data-validate="form" class="form-horizontal form-bordered" autocomplete="off" novalidate="novalidate" method="post">
            <div id="panel-tablesorter" class="panel panel-default">
                ...
                <div class="panel-body">
                    <!--outbound-->
                    <input name="outbound_id" id=outbound_id type="hidden" value="<?= $list['outboundInfo']['outbound_id'] ?>"/>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-8 col-md-7 pull-left">
                                    <input value="<?= $list['outboundInfo']['outbound_name'] ?>" type="text" class="form-control" name="outbound_name" id="outbound_name" autocomplete="off" placeholder="<?=OUTBOUND_11?>" required tabindex="1">
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-6">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-6 col-md-6 custom-grid">
                                    <div class="form-group prepend pos-rel">
                                        <input type="text" class="form-control" name="prepend[]" id="prepend[]" autocomplete="off" placeholder="<?=OUTBOUND_12?>" value="<?= $list['outboundDialPatternInfo']['prepend'][$i]; ?>">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-6 custom-grid">
                                    <div class="form-group prefix pos-rel">
                                        <input type="text" class="form-control" name="prefix[]" id="prefix[]" autocomplete="off" placeholder="<?=OUTBOUND_13?>" value="<?= $list['outboundDialPatternInfo']['prefix'][$i]; ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-6 col-md-6 custom-grid">
                                    <div class="form-group match-pattern pos-rel">
                                        <input type="text" class="form-control" name="match_pattern[]" id="match_pattern[]" autocomplete="off" required placeholder="<?=OUTBOUND_15?>" value="<?= $list['outboundDialPatternInfo']['match_pattern'][$i]; ?>">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-6 custom-grid">
                                    <div class="form-group caller-id pos-rel">
                                        <input type="text" class="form-control" name="caller_id[]" id="caller_id[]" autocomplete="off" placeholder="<?=OUTBOUND_19?>" value="<?= $list['outboundDialPatternInfo']['caller_id'][$i]; ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 col-md-12 col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-md-8 pull-left">
                                    ...
                                    <select class="valid select2" name="priority" id="priority">
                                        <?php foreach ($list['priority'] as $key => $value){ ?>
                                            <option  value="<?=$value['priorityNum'] ?>"
                                                <?=($value['isUsed']=="1" ? 'disabled' : '')?>
                                                <?=($list['outboundInfo']['priority']== $key ? 'selected' : '')?> >
