...
<div class="content active">
    ...
    <div class="content-body">
        ...
        <div class="row margin-bottom">
            <?php if ($admin_info != -1) { ?>
                <!--Announce-->
                <?php if($list['listMenu']['announce']!=0){ ?>
                    ...
                    <!--timeCondition-->
                <?php }if($list['listMenu']['mainTimeCondition']!=0){ ?>
                    <div class="col-xs-6 col-sm-6 col-md-4 col-lg-3">
                ...
                <?php } if($list['listMenu']['extension']!=0){ ?>
                ...
                <?php } if($list['listMenu']['sip']!=0){ ?>
                    ...
                    <!--trunk-->
                <?php } if($list['listMenu']['trunk']!=0){ ?>
                    <div class="col-xs-6 col-sm-6 col-md-4 col-lg-3">
                        <div class="panel panel-default box-items main-page theme-blue full-width">
                            <a class="link-block"
                               rel="tooltip" data-original-title="<?= MORE ?>" data-placement="bottom"
                               href="<?= RELA_DIR . 'trunk.php?action=showTrunk' ?>">
                                <i class="fa fa-volume-control-phone item-center text-32"></i>
                                <div class="panel-body">
                                    <h2 class="text-center text-normal text-midnight no-margin"><?= OUTBOUND_27 ?></h2>
                                </div>
                            </a>
                        </div>
                    </div>
                <?php } if($list['listMenu']['routing']!=0){ ?>
                    <!--routing-->
                    <div class="col-xs-6 col-sm-6 col-md-4 col-lg-3">
                        <div class="panel panel-default box-items main-page theme-orange full-width">
                            <a class="link-block"
                               rel="tooltip" data-original-title="<?= MORE ?>" data-placement="bottom"
                               href="<?= RELA_DIR . 'routing.php?action=showRouting' ?>">
                                <i class="fa fa-random item-center text-32"></i>
                                <div class="panel-body">
                                    <h2 class="text-center text-normal text-midnight no-margin"><?= OUTBOUND_28 ?></h2>
                                </div>
                            </a>
                        </div>
                    </div>
                    <!--inbound-->
                <?php } if($list['listMenu']['inbound']!=0){ ?>
                    ...
                    <!--outbound-->
                <?php } if($list['listMenu']['outbound']!=0){ ?>
                    <div class="col-xs-6 col-sm-6 col-md-4 col-lg-3">
                ...
                <?php } if($list['listMenu']['conference']!=0){ ?>
                    <div class="col-xs-6 col-sm-6 col-md-4 col-lg-3">
                        <div class="panel panel-default box-items main-page theme-light-blue full-width">
                            <a class="link-block"
                               ...
                               href="<?= RELA_DIR . 'conference.php?action=showConference' ?>">
                                <i class="fa fa-video-camera item-center text-32"></i>
                                <div class="panel-body">
