...
<div class="content active">
    ...
    <!--<a href="<?/*=RELA_DIR*/?>extension.php?action=editExtension&id=<?/*=$_GET['id']*/?>">
    ...
    <div class="content-control">
        ...
        <ul class="control-nav pull-left">
            <li>
                <a class="text-20"  href="<?=RELA_DIR?>extension.php?action=editExtension&id=<?=$_GET['id']?>">
                    <?= EXTENSION_25 ?></a>
            </li>
        </ul><!--/control-nav-->
    </div>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12  center-block">
                            ...
                            if( !empty($list['monthStart'])) {
                                ...
                                The Time You Inserted, Has Conflict. Please ReSchedule and Re-Enter New Scheduling Variables
                                              </p>";
                                ...
                                Hour End Have to be Greater Than Hour Start
                                    ...
                                    ?>
                                    <div class="jumbotron no-bg timeTable timeTable<?=$i?>" <?=($list['error'][$i] == 1 or $list['error'][$i] == 2)?$style:''?> >
                                        ...
                                        <div class="row ">
                                            <div class="col-xs-6 col-sm-12 col-md-6 ">
                                                <div class="form-group">
                                                    <label class="col-xs-12 col-sm-4 pull-left control-label ltr "> Days </label>
                                                    <div class="col-xs-6 col-sm-6 col-md-6 ">
                                                        <select name="weekDayStart[]" class="weekDayStart select2" id="weekDayStart" title="" required>
                                            ...
                                            <div class="col-xs-6 col-sm-12 col-md-6 ">
                                                <div class="form-group">
                                                    <label class="col-xs-12 col-sm-4 pull-left control-label ltr "> Days </label>
                                                    <div class="col-xs-6 col-sm-6 col-md-6 ">
                                                        <select name="weekDayEnd[]" class="weekDayEnd select2" id="weekDayEnd" title="" required>
                                                            <?php foreach ($list['weekDaysName'] as $key => $value) { ?>
                                        ...
                                        <div class="row ">
                                            <div class="col-xs-6 col-sm-12 col-md-6 ">
                                                <div class="form-group">
                                                    <label class="col-xs-12 col-sm-4 pull-left control-label ltr "> Days </label>
                                                    <div class="col-xs-6 col-sm-6 col-md-6 ">
                                                        <select name="dayStart[]" class="dayStart select2" id="dayStart" title="" required>
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-12 col-md-6 ">
                                                <div class="form-group">
                                                    <label class="col-xs-12 col-sm-4 pull-left control-label ltr "> Month </label>
                                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-6 col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-xs-6 col-sm-12">
                                                        <select name="dialExtension[]" class="dialExtension select2" title="" id="<?=$i?>" required>
                                            ...
                                            <div class="col-xs-6 col-sm-3">
                                                <div class="form-group">
                                                    <label class="col-xs-6 col-sm-12 pull-left control-label ltr">
                                                        <!--Forward --></label>
                                                    <div class="col-xs-6 col-sm-12 forward" id='<?=$i?>-1' >
                                            ...
                                            <div class="col-xs-6 col-sm-3">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-xs-6 col-sm-12" data-status="DSTOption" id="<?=$i?>-2" >

                                                            <?php if ($list['dialExtension'][$i] == 'forward' & $list['forward'][$i] == 'internal') { ?>
                                                                <select name="DSTOption[]" class="DSTOption select2" id="DSTOption" required >
                                                            ...
                                                            <?php } elseif ($list['dialExtension'][$i] == 'forward' & $list['forward'][$i]  == 'external') { ?>
                                                                <input type='text' class='form-control' value="<?=$list['DSTOption'][$i]?>" name='DSTOption[]' id='external' placeholder='Enter Phone Number' >
                                                            <?php } else { ?>
                            ...
                            if ($list['plus'] == 1) { ?>
                                <div class="jumbotron no-bg row timeTable timeTable<?=$deleteCounter?>">
                                    <div style="cursor: pointer; font-size: 20px; height:60px;">
                                        <i style="color:red;" class="fa fa-times deleteTimeTable" aria-hidden="true"  id="<?=$deleteCounter?>"></i>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-6 col-sm-3">
                                            <div class="form-group">
                                                <label class="col-xs-6 col-sm-12 pull-left control-label ltr">
                                                   <!-- Dial Extension--> </label>
                                                <div class="col-xs-6 col-sm-12">
                                                    <select name="dialExtension[]" class="dialExtension select2" id="<?=$counter+1?>" title="" required>
                                        ...
                                        <div class="col-xs-6 col-sm-3">
                                            <div class="form-group">
                                                <label class="col-xs-6 col-sm-12 pull-left control-label ltr ">
                                                    <!--Forward --></label>
                                                <div class="col-xs-6 col-sm-12 forward" id='<?=$counter+1?>-1'>
                                        ...
                                        <div class="col-xs-6 col-sm-3">
                                            <div class="form-group">
                                                <label class="col-xs-12 col-sm-12 pull-left control-label ltr "> <!--Destination--> </label>
                                                <div class="col-xs-12 col-sm-12 DSTOption" data-status="DSTOption" id="<?=$counter+1?>-2" >
                            ...
                            <div class="row xsmallSpace hidden-xs"></div>
                            <!------------------------- Failed Side ------------------------------>
                            <div class="jumbotron no-bg col-xs-12 col-sm-12 col-md-12" style="border-radius: 30px;">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-6 col-sm-3">
                                        <div class="form-group">
                                            <label class="col-xs-12 col-sm-4 pull-left control-label ltr ">
                                                 <!--Forward--> </label>
                                            <div class="col-xs-12 col-sm-12 FForward" id='<?=$i?>-1'>
                                    ...
                                    <div class="col-xs-6 col-sm-3">
                                        <div class="form-group">
                                            <label class="col-xs-12 col-sm-12 pull-left control-label ltr ">
                                                <!--Destination--> </label>
                                            <div class="col-xs-12 col-sm-12" data-status="FDSTOption" id="<?=$i?>-2">

                                                <?php if ($list['FDialExtension'] == 'forward' & $list['FForward'] == 'internal') { ?>
                                                    <select name="FDSTOption" class="FDSTOption select2" id="FDSTOption" required>
                                                        <?php foreach ($list['extensionList'] as $key => $value) { ?>
                                                ...
                                                <?php } else { ?>
                                                    ...
                                                    <?php if ($list['FDialExtension'] == 'voiceMail' & $list['FForward'] == 'withOutMessage') { ?>
                                                        <input type="hidden" value="" name="SDSTOption">
...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function () {
        ...
        $(".dialExtension").on('change', function(){
            ...
            var forwardId = "#" + id + "-1";
            $.ajax({
                url : "extension.php?action=failedTCForward",
...
//                    var result = $.parseHTML(response, true);
        ...
        $(".forward").on('change', function(){
            ...
            $(DSTOption).show();
            $.ajax({
                url : "extension.php?action=failedTCDSTOption",
