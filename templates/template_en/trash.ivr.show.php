...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function() {
        ...
        var oTable = dataTable.DataTable( {
            "processing": true,
            "serverSide": true,
            "ajax": "<?=RELA_DIR?>trash.php?action=searchIvrTrash&ajax=1"
        } );
...
<div class="content active">
    <div class="content-header">
        <h2 class="content-title"><i class="fa fa-user"></i><?php echo TRASH_05 ?></h2>
    </div><!--/content-header -->
    <div class="content-body">
        <div id="panel-tablesorter" class="panel panel-warning">
            <div class="panel-heading bg-white">
                <h3 class="panel-title"><?php echo TRASH_05 ?></h3>
            ...
            <div class="panel-body">
                ...
                ?>
                <!--form-->
                <form method="post" action="<?=RELA_DIR.'ivr.php?action=changeStatus';?>" name="action" id="action">
                    <div class="content-body">
                        ...
                        <table id="example" class="companyTable table table-striped table-bordered" cellspacing="0" width="100%">
                            <thead>
                            <tr>
                                <th><?php echo IVR_03 ?></th>
                                <th><?php echo IVR_04 ?></th>
                                <th><?php echo IVR_05 ?></th>
                                <!-- <th>Invalid</th>-->
                                <th><?php echo IVR_06 ?></th>
                                <th><?php echo IVR_07 ?></th>
                                <th><?php echo IVR_08 ?></th>
                                <th><?php echo IVR_09 ?></th>
                                <th><?php echo IVR_10 ?></th>
                                <th><?php echo IVR_11 ?></th>
                            </tr>
                            </thead>
                            <tfoot>
                            <tr>
