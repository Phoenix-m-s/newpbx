...
class AdminUserService
{
    ...
    public function saveToAdmin($fields)
    {
        ...
        $user->status = 1;
        $user->member_id = 0;
        $user->permission_pbx='100000000011110000001000000000111100000011110000001111000000111100000011110000001111000000111100000011110000001111000000110000000011100000001000000000111100000010000000001000000000000000000010000000000000000000';
